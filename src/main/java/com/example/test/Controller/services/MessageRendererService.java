package com.example.test.Controller.services;
...
public class MessageRendererService extends Service {
    ...
    private StringBuffer stringBuffer; // Will hold the content that will be rendered by the WebEngine,
    // When we load the message content, we will put them inside the StringBuffer
    // And then the WebEngine will load the StringBuffer
